...
public class PlayerNeededValues : MonoBehaviour
{
   ...
   IEnumerator BeingThrown()
    ...
    public static bool RightBlindPointDebug { get; private set; }
    public static bool LeftBlindPointDebug { get; private set; }
    ...
    void Update()
    {
        ...
        IsGroundedPlayer = Physics2D.Raycast(player.transform.position, Vector2.down, 1.1f, groundLayer) || Physics2D.Raycast(player.transform.position + new Vector3(0.25f, 0f, 0f), Vector2.down, 1.1f, groundLayer) || Physics2D.Raycast(player.transform.position + new Vector3(0.5f, 0f, 0f), Vector2.down, 1.1f, groundLayer) || Physics2D.Raycast(player.transform.position - new Vector3(0.25f, 0f, 0f), Vector2.down, 1.1f, groundLayer);
        ...
        IsGroundedPlayerDebug = Physics2D.Raycast(player.transform.position, Vector2.down, 1.5f, groundLayer);
